...
from superagi.tools.google_calendar.create_calendar_event import (
...
class TestCreateEventCalendarTool(unittest.TestCase):
    ...
    def test_execute(self, mock_create_event_dates, mock_get_credentials):
        ...
        output_str = self.create_event_tool._execute(
            "Test Event",
            "A test event",
            ["test@example.com"],
            start_date="2022-01-01",
        ...
        mock_create_event_dates.assert_called_once_with(
            mock_service, "2022-01-01", "12:00:00", "2022-01-01", "13:00:00"
        )
