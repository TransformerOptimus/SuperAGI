...
from superagi.tools.google_calendar.delete_calendar_event import DeleteCalendarEventInput, DeleteCalendarEventTools
...
class TestDeleteCalendarEventTools(unittest.TestCase):
    ...
    def setUp(self):
        self.delete_tool = DeleteCalendarEventTools()
