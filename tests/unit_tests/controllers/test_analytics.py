...
# updated the test functions to use mock_organisation and mock session object
@patch('superagi.apm.analytics_helper.db.session')
@patch('superagi.helper.auth.get_user_organisation', return_value=mock_organisation)
def test_get_metrics_success(get_user_organisation, mock_session):
...
@patch('superagi.apm.analytics_helper.db.session')
@patch('superagi.helper.auth.get_user_organisation', return_value=mock_organisation)
def test_get_agents_success(get_user_organisation, mock_session):
    with patch('superagi.controllers.analytics.AnalyticsHelper') as mock_helper:
...
@patch('superagi.apm.analytics_helper.db.session')
@patch('superagi.helper.auth.get_user_organisation', return_value=mock_organisation)
def test_get_agent_runs_success(get_user_organisation, mock_session):
    with patch('superagi.controllers.analytics.AnalyticsHelper') as mock_helper:
...
@patch('superagi.apm.analytics_helper.db.session')
@patch('superagi.helper.auth.get_user_organisation', return_value=mock_organisation)
def test_get_active_runs_success(get_user_organisation, mock_session):
    with patch('superagi.controllers.analytics.AnalyticsHelper') as mock_helper:
...
@patch('superagi.apm.analytics_helper.db.session')
@patch('superagi.helper.auth.get_user_organisation', return_value=mock_organisation)
def test_get_tools_user_success(get_user_organisation, mock_session):
