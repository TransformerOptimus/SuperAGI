...
def test_get_metrics_success():
    with patch('superagi.helper.auth.get_user_organisation') as mock_org, \
        patch('superagi.apm.analytics_helper.AnalyticsHelper') as mock_helper:

        mock_org.return_value = 'dummy_organisation'
...
def test_get_tools_user_success():
    with patch('superagi.helper.auth.get_user_organisation') as mock_org, \
        patch('superagi.apm.tools_handler.ToolsHandler') as mock_handler:
