...
class TestKnowledgeSearchTool(unittest.TestCase):
    ...
    @patch(
        "superagi.models.vector_db_configs.VectordbConfigs.get_vector_db_config_from_db_id"
    )
    ...
    def test_execute(
        self,
        mock_get_embedding,
        mock_fetch_configuration,
        mock_get_vector_db_config_from_db_id,
        mock_get_vector_db_from_id,
        mock_get_vector_index_from_id,
        mock_Toolkit,
        mock_AgentConfiguration,
        mock_get_knowledge_from_id,
    ):
