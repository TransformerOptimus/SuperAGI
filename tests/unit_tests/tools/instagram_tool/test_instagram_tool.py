...
from superagi.tools.instagram_tool.instagram import (
    InstagramTool,
)  # Replace 'your_file' with actual file name that contains this class
...
class TestInstagramTool(unittest.TestCase):
    ...
    def test_create_caption(self):
        ...
        self.instagram_tool.llm.chat_completion.return_value = {
            "content": expected_caption
        }
    ...
    def test_get_file_path(self, mock_resource_helper):
        mock_session, mock_file_name, mock_agent_id, mock_agent_execution_id = (
            Mock(),
            Mock(),
            Mock(),
            Mock(),
        ...
        actual_path = self.instagram_tool.get_file_path(
            mock_session, mock_file_name, mock_agent_id, mock_agent_execution_id
        )
    ...
    def test_get_img_public_url(self, mock_get_config, mock_s3_helper):
        ...
        expected_url = (
            f"https://{bucket_name}.s3.amazonaws.com/instagram_upload_images/filename"
        )
