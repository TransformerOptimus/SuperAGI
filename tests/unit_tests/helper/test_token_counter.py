...
def test_count_message_tokens():
    messages = [BaseMessage(role="system", content="You are a helpful assistant.")]
    ...
    messages = [BaseMessage(role="system", content="You are a helpful assistant."),
                BaseMessage(role="user", content="What is your name?")]
...
def test_count_text_tokens():
    ...
    assert TokenCounter.count_text_tokens(text) == 7

    text = "What is your name?"
    assert TokenCounter.count_text_tokens(text) == 6