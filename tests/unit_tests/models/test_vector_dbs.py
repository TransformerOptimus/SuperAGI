...
class TestVectordbs(unittest.TestCase):
    def setUp(self):
        ...
        self.test_vector_db = Vectordbs(
            name="test_db", db_type="test_db_type", organisation_id=1
        )
    ...
    def test_get_vector_db_from_organisation(self):
        ...
        returned_db_list = Vectordbs.get_vector_db_from_organisation(
            self.mock_session, Mock(id=1)
        )
    ...
    def test_add_vector_db(self):
        ...
        new_db = Vectordbs.add_vector_db(
            self.mock_session, "test_db", "test_db_type", Mock(id=1)
        )
