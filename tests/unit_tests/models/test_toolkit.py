...
def test_add_or_update_existing_toolkit(mock_session):
    ...
    # Act
    result = Toolkit.add_or_update(
        mock_session, name, description, show_toolkit, organisation_id, tool_code_link
    )
...
def test_fetch_marketplace_list_success():
    ...
    page = 1
    expected_response = [
        {"id": 1, "name": "ToolKit 1", "description": "Description 1"},
        {"id": 2, "name": "ToolKit 2", "description": "Description 2"},
    ]
...
def test_fetch_marketplace_detail_success():
    ...
    expected_response = {"id": 1, "name": "ToolKit 1", "description": "Description 1"}
...
def test_get_toolkit_from_name_existing_toolkit(mock_session):
    ...
    mock_session.query.return_value.filter_by.assert_called_once_with(
        name=toolkit_name, organisation_id=organisation.id
    )
...
def test_get_toolkit_installed_details(mock_session):
    ...
    installed_toolkits = [Toolkit(name="Toolkit 1"), Toolkit(name="Toolkit 3")]
    mock_session.query.return_value.filter.return_value.all.return_value = (
        installed_toolkits
    )

    # Act
    result = Toolkit.get_toolkit_installed_details(
        mock_session, marketplace_toolkits, organisation
    )
