...
import {removeTab, returnDatabaseIcon, setLocalStorageArray, setLocalStorageValue} from "@/utils/utils";
      ...
      {activeView === 'form_database' && <div className="col-6" style={{overflowY:'scroll',height:'calc(100vh - 92px)',padding:'25px 20px'}}>
        ...
        {selectedDB === 'Pinecone' && <div>
          <div style={{marginTop:'15px'}}>
            ...
            <input className="input_medium" type="password" value={pineconeApiKey} onChange={handlePineconeAPIKeyChange}/>
          </div>
          <div style={{marginTop:'15px'}}>
            <label className={styles1.form_label}>Pinecone environment</label>
            <input className="input_medium" type="text" value={pineconeEnvironment} onChange={handlePineconeEnvironmentChange}/>
          </div>
        </div>}
