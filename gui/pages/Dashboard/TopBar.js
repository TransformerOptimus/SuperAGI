  ...
  return (
    <div className={styles.top_bar}>
      ...
      <div className={styles.top_right}>
        ...
        {dropdown && <div style={{marginTop:'4vh',marginRight:'74px'}} onMouseEnter={() => setDropdown(true)} onMouseLeave={() => setDropdown(false)}>
          <ul className="dropdown_container" style={{width:'120px'}}>
            <li className="dropdown_item" style={{maxWidth: '140px'}} onClick={() => setDropdown(false)}>Username</li>
