                ...
                <div className="overflow_auto w_100">
                  <table className="table_css mt_10" style={{margin: 0}}>
                    ...
                    {toolsUsed.map((tool, index) => (
                      <tr key={index}>
                        <td className="table_data" style={{width: '100%', display:'flex', alignItems:'center'}}><Image className="image_class" style={{background: 'black'}} width={20} height={20} src={returnToolkitIcon(tool.toolkit)} alt="tool-icon"/><span>{tool.tool_name}</span></td>
