...
import TaskQueue from '../Agents/TaskQueue';
import RunHistory from "../Agents/RunHistory";
import ActionConsole from "../Agents/ActionConsole";
...
export default function AgentWorkspace({agentId}) {
    ...
    const models = ['Cluster', 'Agent1', 'Agent2','Agent3']
        ...
        <div style={{display:'flex'}}>
            ...
            <div style={{width: history ? '40%' : '60%'}}>
                <div className={styles.detail_top}>
                    ...
                    <div style={{display:'flex'}}>
                            <div className="dropdown_container_search" style={{marginRight:'10px'}}>
            ...
            <div style={{width:'40%'}}>
                ...
                <div className={styles.detail_body} style={{paddingRight:'0'}}>
                    ...
                    {rightPanel === 'details' && <div className={styles.detail_content}><Details agentDetails={agentDetails} tools={tools} runCount={agentExecutions?.length || 0} isCluster={true}/></div>}
