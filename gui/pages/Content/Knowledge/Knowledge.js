    ...
    <>
      <div className={styles1.container}>
        ...
        <div className={styles1.wrapper} style={{marginBottom:'10px',marginTop:'4px'}}>
          <button style={{width:'100%'}} className="secondary_button" onClick={() => sendKnowledgeData({ id: -6, name: "new knowledge", contentType: "Add_Knowledge", internalId: createInternalId() })}>
            + Add Knowledge
          </button>
        </div>
