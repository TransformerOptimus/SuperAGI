...
Example to use a local CodeLLama model from Ollama.ai with SuperAGI: 

Let's spin up a proxy server to route any OpenAI call from SuperAGI to Ollama/CodeLlama
