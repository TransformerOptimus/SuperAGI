...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_schedule_expiry_date"),
        "agent_schedule",
        ["expiry_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_schedule_status"), "agent_schedule", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_agent_schedule_agent_id"), "agent_schedule", ["agent_id"], unique=False
    )
