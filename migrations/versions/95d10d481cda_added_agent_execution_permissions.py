...
def upgrade() -> None:
    ...
    op.add_column('agent_execution_feeds', sa.Column('agent_execution_feed_id', sa.Integer(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('agent_execution_feeds', 'agent_execution_feed_id')
