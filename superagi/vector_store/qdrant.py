...
class Qdrant(VectorStore):
    ...
    def __init__(
        self, client: QdrantClient, embedding_model: Any, collection_name: str
    ...
    def create_collection(self, collection_name, size: int = 1536):
        ...
        for i in range(num_batches):
            ...
            self.client.upsert(
                ...
                points=models.Batch.construct(
                    ids=id_batch,
                    vectors=self.get_embeddings(text_batch),
    ...
    def get_matching_text(
        ...
        return self.build_documents(results)
