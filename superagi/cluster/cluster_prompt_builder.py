...
class ClusterPromptBuilder:
    ...
    @classmethod
    def replace_task_based_variables(cls, super_agi_cluster_prompt: str, current_task: str):
        if "{current_task}" in super_agi_cluster_prompt:
            super_agi_cluster_prompt = super_agi_cluster_prompt.replace("{current_task}", current_task)
        return super_agi_cluster_prompt
