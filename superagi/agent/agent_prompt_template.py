...
class AgentPromptTemplate:
    ...
    def get_super_agi_single_prompt(cls):
        ...
        return {
            ...
            "variables": ["goals", "instructions", "constraints", "tools"],
        }
    ...
    def start_task_based(cls):
        ...
        return {
            "prompt": AgentPromptTemplate.clean_prompt(super_agi_prompt),
            "variables": ["goals", "instructions"],
        }
    ...
    def analyse_task(cls):
        ...
        super_agi_prompt = AgentPromptTemplate.clean_prompt(super_agi_prompt).replace(
            "{constraints}", AgentPromptTemplate.add_list_items_to_string(constraints)
        )
        return {
            "prompt": super_agi_prompt,
