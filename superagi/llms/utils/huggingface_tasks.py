...
class TaskParamters:
    ...
    def _generate_params(self):
        return {
            Task.TEXT_GENERATION: TextGenerationParameters().__dict__,
            Task.SUMMARIZATION: SummarizationParams().__dict__
        }

    def _validate_params(self):
        assert len(self.params) == len(Task), "Not all tasks have parameters defined"
