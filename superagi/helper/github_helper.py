...
class GithubHelper:
    ...
    def create_branch(self,repository_name,base_branch,head_branch,headers):
        ...
        branch_params = {
            ...
            'sha': requests.get(f'https://api.github.com/repos/{self.github_username}/{repository_name}/git/refs/heads/{base_branch}',headers=headers).json()['object']['sha']
        }
    ...
    def add_file(self,repository_owner,repository_name,file_name,folder_path,head_branch,base_branch,headers,body,commit_message):
