...
### 🔧 **Add Email configuration settings in your Dashboard**

Navigate Email Toolkit Page in your in the Toolkit Section:

![Config_Page](https://github.com/Phoenix2809/SuperAGI/assets/133874957/551fd225-417b-4fc2-abd0-a356801fe391)
...
1. _Email address and password:_
 ...
 - Add the 'EMAIL_SMTP_HOST', 'EMAIL_SMTP_PORT', AND 'EMAIL_IMAP_HOST' according to your email service provider.

3. _Optional Settings:_
 - Change the 'EMAIL_SIGNATURE' to your personalise signature.
 - Add the draft folder for your email service provider to prevent it from being sent and instead save it in drafts. If not required, set to "False".
